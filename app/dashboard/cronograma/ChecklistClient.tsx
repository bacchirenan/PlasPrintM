                                            ...
                                            >
                                                ...
                                                <div className="checklist-item-content">
                                                    ...
                                                    <div className="checklist-item-meta">
                                                        ...
                                                        {lastLog && (
                                                            <span className="user-tag" style={{ display: 'inline-flex', alignItems: 'center', gap: '4px' }}>
                                                                <div style={{ width: '16px', height: '16px', borderRadius: '50%', overflow: 'hidden', background: 'var(--primary-accent)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '9px', color: 'white', flexShrink: 0 }}>
                                                                    {((lastLog.user as Profile | undefined)?.avatar_url) ? (
                                                                        <img src={(lastLog.user as Profile).avatar_url!} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                                                    ) : (
                                                                        ((lastLog.user as Profile | undefined)?.full_name?.[0] || (lastLog.user as Profile | undefined)?.email?.[0] || 'U').toUpperCase()
                                                                    )}
                                                                </div>
